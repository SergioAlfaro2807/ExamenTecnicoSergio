...
let db = mongoose.connection,
    dburl = 'mongodb://Sergio2807:Andrey2807@ds147461.mlab.com:47461/pokemonsergio',
    port = 4000;
 ...
 */
const entrenador = require('./componentes/entrenador/entrenador.route');
const pokemon = require('./componentes/pokemon/pokemon.route');
const captura = require('./componentes/captura/captura.route');
